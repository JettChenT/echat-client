...
class LoginForm(QWidget):
    def __init__(self, server_exec,appctxt):
...
class ChatWindow(QWidget):
    def __init__(self, server_exec,appctxt):
        ...
        self.loginWindow = LoginForm(self.server_exec,self.appctxt)
    ...
    def init_colors(self):
        with open(self.appctxt.get_resource("colorsconfig.json")) as f:
...
class MainWindow(QMainWindow):
    def __init__(self,appctxt):
        ...
        self.setStyleSheet(open(stylesheet).read())
        print(server,port)
        self.server_exec = Executer((server, port),alias_url = self.appctxt.get_resource("alias.json"))
